...
def menu_buttons():
    ...
    mouse = pygame.mouse.get_pos() # Get mouse position once
    ...
    button_text = button_font.render("Settings", True, (255, 255, 255))
    ...
    size = (300, 50)
    button_text = button_font.render("Tutorial", True, (255, 255, 255))
    ...
    # --- BUTTON 4: View Rankings (Leaderboard) ---
